...
failo_kelias = '30_paskaita/prekes.txt'
...
def prideti_preke():
    try:
        ...
        with open('30_paskaita/prekes.txt', '+a') as failas:
...
def nuskaityti_faila(failo_pavadinimas):
    ...
    try:
        with open(failo_pavadinimas, 'r') as failas:
            ...
            print('Failas nuskaityta sekmingai')
            print(eilutes)
    except Exception as e:
        print(f'klaida: {e}')
...
def pasalinti_preke():
    ...
    print()
    istrinti = input('Iveskite index prekes kuria norit istrinti: ')
    try:
        preke = parduotuve.istrinti_preke(istrinti)
        print(preke)
...
def gauti_surikiuotas_prekes():
    ...
    while rikiuoti_pagal not in ['pavadinimas', 'kaina', 'kiekis']:
        rikiuoti_pagal = input('Iveskite pagal ka norite rikiuoti(pavadinimas/kaina/kiekis): ').lower
...
def atnaujinti_preke():
    ...
    parduotuve.perziureti_prekes()
    print()
    atnaujinti = int(input('Iveskite index prekes kuria norit atnaujinti: '))
    try:
