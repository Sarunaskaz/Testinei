...
class Ligonine:
    ...
    def prideti_gydytoja(self, vardas, pavarde, specializacija, el_pastas):
        ...
        self.cursor.execute("INSERT INTO gydytojai (vardas, pavarde, specializija, el_pastas) VALUES (?, ?, ?, ?)", (vardas, pavarde, specializacija, el_pastas))
    ...
    def prideti_susitikima(self, paciento_id, gydytojo_id, susitikimo_data, paskirtis, komentarai):
        ...
        self.cursor.execute("INSERT INTO gydytojai (paciento_id, gydytojo_id, susitikimo_data, paskirtis, komentarai) VALUES (?, ?, ?, ?,?)", (paciento_id, gydytojo_id, susitikimo_data, paskirtis, komentarai))
        self.conn.commit()
        return susitikimas
